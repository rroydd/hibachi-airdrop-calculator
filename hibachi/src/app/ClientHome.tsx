...
const PUBLIC_SITE_URL = "https://hibachi-airdrop-calculator.vercel.app/";
...
Calculate yours: ${REFERRAL_LINK}`;
  function buildShareParams(backgroundIndex: number) {
    return new URLSearchParams({
      amount: usd.format(finalAirdropUsd),
      points: `${numberWithCommas.format(userPoints)} points`,
      tokens: `${compactNumber.format(finalTokens)} $HEAT`,
      nft: includeNftBonus ? nftCollection : "No NFT",
    ...
    <main className="min-h-screen overflow-x-hidden px-4 py-6 text-white sm:px-6 lg:px-8">
      ...
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-6">
        <div className="flex justify-end">
          <a
            className="inline-flex items-center justify-center rounded-lg border border-orange-300/20 bg-zinc-950/70 px-4 py-2 text-sm font-semibold text-orange-100 transition hover:border-orange-300/60 hover:bg-orange-500/15 hover:text-white"
            href={PORTAL_URL}
          >
            Back to Alpha Tools
          </a>
          ...
          <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
            <div className="max-w-2xl">
              ...
              <p className="mt-3 max-w-xl text-base leading-7 text-zinc-300">
                Estimate your potential airdrop based on points, FDV, token allocation, and farming costs.
              </p>
